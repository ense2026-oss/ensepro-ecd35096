...
const DayOff = () => {
  ...
  const cellColor = (status: string) => {
    switch (status) {
      ...
      case "pattern": return { bg: "hsl(0 70% 90%)", color: "hsl(0 70% 35%)", label: "หยุด" };
      case "extra": return { bg: "hsl(31 90% 88%)", color: "hsl(31 90% 35%)", label: "หยุด" };
        ...
        <TabsContent value="calendar" className="space-y-4">
          ...
          <div ref={calendarScrollRef} className="overflow-auto max-h-[calc(100vh-200px)] cursor-grab touch-none">
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr>
                  <th className={cn("sticky left-0 top-0 py-2 text-left font-semibold border-b border-r whitespace-nowrap z-30", empColCollapsed ? "px-0 w-px" : "px-3")} style={{borderColor:"hsl(var(--border))", background:"hsl(var(--card))"}}>
