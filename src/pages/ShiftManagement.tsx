        ...
        <TabsContent value="calendar" className="space-y-4">
          ...
          <div ref={calendarScrollRef} className="overflow-auto max-h-[calc(100vh-200px)] cursor-grab touch-none">
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr>
                  <th className={cn("sticky left-0 top-0 py-2 text-left font-semibold border-b border-r z-30", empColCollapsed ? "px-1 w-px" : "px-3 min-w-[180px]")} style={{ borderColor: "hsl(var(--border))", background: "hsl(var(--card))" }}>
